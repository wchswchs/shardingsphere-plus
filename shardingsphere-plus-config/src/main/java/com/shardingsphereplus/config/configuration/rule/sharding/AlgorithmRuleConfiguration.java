package com.shardingsphereplus.config.configuration.rule.sharding;

import com.shardingsphereplus.config.Configuration;
import com.shardingsphereplus.config.configuration.rule.sharding.algorithm.AlgorithmProperties;
